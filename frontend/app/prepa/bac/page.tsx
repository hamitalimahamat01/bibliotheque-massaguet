    ...
    <div className="animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-3xl p-8 mb-8 text-white">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Prépa BAC</h1>
            <p className="text-white/90 text-sm">Documents pour les élèves de Terminale</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-4 py-2.5 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none"
              />
            ...
            <select
              ...
              className="px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none bg-white min-w-[150px]"
            >
      ...
      {loading ? (
                ...
                <Link href={`/books/${book.id}`} className="block">
                  <div className="relative h-48 bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center">
                    {book.coverUrl ? (
                      ...
                      <Icons.Book className="w-16 h-16 text-green-400" />
                    )}
                    <div className="absolute top-3 right-3 flex gap-2">
                      ...
                      {book.subject && (
                        <span className="text-xs font-medium px-2 py-1 rounded-full bg-green-500/90 backdrop-blur text-white">
                          {book.subject}
                        </span>
                      )}
                    </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-12 text-center">
          ...
          <p className="text-gray-400 mt-1">
            Aucun document n'a été trouvé pour la Prépa BAC
          </p>
          {user && (
            <Link
              href="/books/upload"
