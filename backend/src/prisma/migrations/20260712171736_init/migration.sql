...
-- CreateIndex
CREATE UNIQUE INDEX "downloads_userId_bookId_key" ON "downloads"("userId", "bookId");
...
-- AddForeignKey
ALTER TABLE "downloads" ADD CONSTRAINT "downloads_bookId_fkey" FOREIGN KEY ("bookId") REFERENCES "books"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
